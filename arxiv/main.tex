...
This discipline is central: the result is not that an analyst can separate high- and low-residual galaxies after inspecting residuals, but that residual-blind external evidence predicts the frozen endpoint. The packet records this audit layer in \texttt{labeling\_protocol.md}, which defines the source rules and A/B/C decision logic, and in \texttt{external\_evidence\_table.csv}, which gives row-level evidence summaries, source links, reviewer/date fields, and residual-blind flags.
...
\caption{Figure 1. Residual scatter by external class.}
...
\caption{Figure 2. C-minus-A control effects.}
...
\caption{Figure 3. Distance-bin effects.}
...
figure & file & role \\
\midrule
Figure 1 & \texttt{figures/quality\_pass\_rms\_distribution.svg} & quality-selected class-separated primary endpoint \\
Figure 2 & \texttt{figures/control\_forest\_plot.svg} & primary and control effects on one scale \\
Figure 3 & \texttt{figures/distance\_stratified\_effects.svg} & distance-bin directionality check \\
\bottomrule
\end{tabularx}
\end{table}
...
The key supplementary tables are \texttt{external\_evidence\_table.csv} for row-level label evidence, \texttt{baseline\_score\_comparisons.md} for alternative-score checks, \texttt{selection\_observability\_appendix.md} and \texttt{controlled\_regression\_appendix.md} for observability controls, and \texttt{effect\_size\_appendix.md} plus \texttt{inclination\_systematics\_appendix.md} for effect-size and kinematic-systematics summaries.
...
\end{verbatim}
Key audit files include \texttt{final\_tables.md}, \texttt{external\_evidence\_table.csv}, \texttt{baseline\_score\_comparisons.md}, \texttt{selection\_observability\_appendix.md}, \texttt{controlled\_regression\_appendix.md}, \texttt{effect\_size\_appendix.md}, and \texttt{inclination\_systematics\_appendix.md}.
...
\section*{References}
\begin{itemize}
\item Lelli, F., McGaugh, S. S., \& Schombert, J. M. 2016, AJ, 152, 157, "SPARC: Mass Models for 175 Disk Galaxies with Spitzer Photometry and Accurate Rotation Curves", doi:10.3847/0004-6256/152/6/157.
\item McGaugh, S. S., Lelli, F., \& Schombert, J. M. 2016, PRL, 117, 201101, "The Radial Acceleration Relation in Rotationally Supported Galaxies", doi:10.1103/PhysRevLett.117.201101.
\item Lelli, F., McGaugh, S. S., Schombert, J. M., \& Pawlowski, M. S. 2017, ApJ, 836, 152, "One Law to Rule Them All: The Radial Acceleration Relation of Galaxies", doi:10.3847/1538-4357/836/2/152.
\item van Eymeren, J., Jutte, E., Jog, C. J., Stein, Y., \& Dettmar, R.-J. 2011, A\&A, 530, A30, "Lopsidedness in WHISP galaxies. II. Morphological lopsidedness", doi:10.1051/0004-6361/201016178.
\item Di Teodoro, E. M., \& Fraternali, F. 2015, MNRAS, 451, 3021, "3DBarolo: a new 3D algorithm to derive rotation curves of galaxies", doi:10.1093/mnras/stv1213.
\item Iorio, G., Fraternali, F., Nipoti, C., Di Teodoro, E. M., Read, J. I., \& Battaglia, G. 2017, MNRAS, 466, 4159, "LITTLE THINGS in 3D: robust determination of the circular velocity of dwarf irregular galaxies", doi:10.1093/mnras/stw3285.
\item Oman, K. A., et al. 2019, MNRAS, 482, 821, "Non-circular motions and the diversity of dwarf galaxy rotation curves".
\item Oh, S.-H., Hunter, D. A., Brinks, E., et al. 2015, AJ, 149, 180, "High-resolution Mass Models of Dwarf Galaxies from LITTLE THINGS", doi:10.1088/0004-6256/149/6/180.
\end{itemize}
\section{Conclusion}
