...
The full reproducibility package, including the frozen labels, external evidence table, baseline-score comparisons, control summaries, figures, and regeneration scripts, is archived at \href{https://doi.org/10.5281/zenodo.20181556.}{\nolinkurl{doi:10.5281/zenodo.20181556.}} The analysis can be regenerated with the commands listed in Section 13.
