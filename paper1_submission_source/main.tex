...
\date{May 14, 2026\\Last revised: August 30, 2026}
\begin{document}
\maketitle
\begin{abstract}
...
The full reproducibility package, including the frozen labels, external evidence table, baseline-score comparisons, control summaries, figures, and regeneration scripts, is archived at \href{https://doi.org/10.5281/zenodo.20285859}{\nolinkurl{doi:10.5281/zenodo.20285859}}. The analysis can be regenerated with the commands listed in Section 13.
